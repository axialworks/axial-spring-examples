...
import com.axial.examples.single_database.database.model.UserHobbyExtNoMapperModel;
import com.axial.examples.single_database.database.model.UserHobbyExtRowMapperModel;
...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Query(
            "SELECT"
                + " new com.axial.examples.single_database.database.model.UserHobbyExtNoMapperModel("
