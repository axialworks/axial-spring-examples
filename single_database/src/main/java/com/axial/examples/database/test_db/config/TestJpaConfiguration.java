...
@EnableJpaRepositories(
        basePackages = {
                "com.axial.examples.database.test_db.repository.jpa",
                "com.axial.examples.database.test_db.repository.entity_manager"
        },
...
public class TestJpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean testEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.axial.examples.database.test_db.entity")
                .build();
    }
