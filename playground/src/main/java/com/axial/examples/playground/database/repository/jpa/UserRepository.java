...
import com.axial.examples.playground.database.model.UserHobbyExtNoMapperModel;
...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Query(
            "SELECT"
                + " new com.axial.examples.playground.database.model.UserHobbyExtNoMapperModel("
