...
@EnableJpaRepositories(
        basePackages = {
                "com.axial.examples.multiple_database.database.app_db.repository.jpa",
                "com.axial.examples.multiple_database.database.app_db.repository.entity_manager"
        },
...
public class AppJpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean appEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.axial.examples.multiple_database.database.app_db.entity")
                .build();
    }
