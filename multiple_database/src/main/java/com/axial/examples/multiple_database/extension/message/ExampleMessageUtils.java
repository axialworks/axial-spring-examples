package com.axial.examples.multiple_database.extension.message;

import com.axial.examples.multiple_database.extension.message.constants.ExampleMessageConstants;
